...
playarea.addEventListener("click", function(){
    ...
    if(distance_new < distance_old){
        document.getElementById("hint").innerHTML = "hot - You getter closer :) :)";
        document.getElementById("hint").style.color = "green";
    } else {
        document.getElementById("hint").innerHTML = "cold - You going far :( :(";
...
reset.addEventListener("click", function(){
    ...
    document.getElementById("hint").innerHTML = "Click playing area to play";
...
targetarea.addEventListener("click", function(){
    ...
    alert("You clicked " + clickCount + " times." + "YOU WON THE GAME!!!");
});
